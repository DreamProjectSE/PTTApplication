...
public class PTTApplication {
	...
	public static void main (String args[])
	{
		...
		ArrayList<Skill> skills = CVSReader.populateSkills(path);
		...
		ArrayList<CourseRequirement> courseRequirements = CVSReader.populateCourseRequirements(path,skills);
		...
		ArrayList<Teacher> teachers = CVSReader.populateTeachers(path,skills);
